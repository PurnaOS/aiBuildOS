          ...
          <button
            ...
            onClick={() =>
              setDraft((current) => ({
                ...
                // nothing downstream can look the preset back up. Assigned unconditionally — a
                // preset that maps nothing must *clear* the last one's mapping, and `undefined`
                // both validates and drops out of the saved JSON.
